...
\begin{tabular}{|c||c|c|c|c|} \hline
	\textbf{Component} & \textbf{Mass (g)} & \textbf{Power (W)} & \textbf{Thermal, oper. ($^\circ$C)} & \textbf{Thermal, stor. ($^\circ$C)} \\ \hline \hline
...
\begin{table}[htbp]
  ...
  \caption{ADCS Sensors and Actuators}
    ...
    \hline
    \multirow{2}[2]{*}{Sun sensors} & \multirow{2}[2]{*}{5} & \multicolumn{1}{c|}{\multirow{2}[2]{*}{CubeSat shop}} & \multicolumn{2}{l|}{- Field of view: 114$^\circ$} \bigstrut[t]\\
...
\section{Thermal Heat Fluxes} \label{app:thermal}
%\begin{landscape}
%\begin{center}
%\begin{longtable}{| p{2cm} | p{1.1cm} | p{1.1cm} | p{1.1cm} | p{1.1cm} | p{1.1cm} | p{1.1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} |}
%\caption{Raw results of thermal calculations for cold case.}
%\label{tab:thermal-raw-cold}\\
%\hline
    %\multicolumn{8}{|l|}{Cold Case 500 km $\beta = 0$} & \multicolumn{6}{|l|}{Total (modes)}  \\
    %\hline \hline
    %Surface \# & 1 & 2 & 3 & 4 & 5 & 6 & \multirow{2}{1.1cm}{Total (initial estimate)} &  \multirow{2}{1.1cm}{Data capture} &  \multirow{2}{1.1cm}{Standby} &  \multirow{2}{1.1cm}{Uplink} & \multirow{2}{1.1cm}{Downlink} &  \multirow{2}{1.1cm}{Safe Mode} &  \multirow{2}{1.1cm}{Detumbling} \\\cline{1-7}
    %Description & Zenith-Y & Nadir-Y & Sun-P & A-Sun-P & Ram-R & A-Ram-R & \\\hline
%\end{longtable}
%\end{center}
%
%\end{landscape}
