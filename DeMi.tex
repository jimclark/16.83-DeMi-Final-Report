...
\centering
%\includegraphics[width=2in]{}
\caption{Photo and Artist’s rendering of ISIS Deployable Antenna. Images from ISIS~\cite{isis-cubesat}}
\label{fig:str-2-3}
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=4in]{images/STR-6-revised.jpg}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=4in]{images/STR-7(2).png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=4in]{images/STR-8.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=4in]{images/STR-9.png}
