...
To determine the pointing requirement, we first need to calculate the plate scale of the detector, and the amount of time needed to get a reasonable SNR for a star of a reasonable magnitude. To calculate the plate scale of the detector, we need to 
