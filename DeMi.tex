...
During external data acquisition, it is desirable to have the same points of the image of the star be on the same pixels of the detector for the duration of the exposure time, so that the image of the star is not smeared across the detector.
...
The maximum exposure time used occurs during ``Diagnostic Mode'' at 10 fps, which corresponds to a maximum exposure time of 0.1 seconds. Plugging everything into this equation, the maximum slew rate requirement during external source data acquisition is $\frac{22 \text{ arcseconds/pixel}}{0.1 \text{ s}} \approx 4.7$ arcminutes/s.
