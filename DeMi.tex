...
\begin{table}
    ...
    \hline
    Detector                      & Req. PLD-2 &47-20&DCC1545M&UI1221LE-M&UI5241LE-M\\ \hline
...
In Eq.~\ref{eq:comm-antenna-length}, $l$ is the length of the antenna, and $\lambda$ is the wavelength. Using a wavelength of $.645$ meters, the desired length of the antenna is about $.16$ meters. The gain of this antenna will be approximately $3\ dB$ and the beam width approximately $65^\circ$.
...
As of PDR, there were no design risks for the communications subsystem. Initially, there were concerns that communications may not be able to downlink enough of the data from the payload, however, avionics has decided that because of this risk, DeMi will be doing on-board processing so that less data is required to be downlinked.
